...
(`title`, `alias`, `agent_id`, `property_type`, `status`, `sale_or_rent`, `price`, `bedrooms`, `bathrooms`, `area_sqft`, `address`, `city`, `description`, `featured`, `main_image`, `published`) VALUES
...
'The house is an elegant villa located in a quiet leafy estate in Karen. An open plan living and dining area flows onto a landscaped garden with a private pool. Finished with imported fittings, solid wood flooring and a gourmet kitchen.', 1, 'images/properties/karen-villa.jpg', 1),
...
'A bright and modern 2-bedroom apartment in a secure gated development. Features a spacious balcony, fitted kitchen, and access to gym and rooftop lounge. Ideal for professionals.', 1, 'images/properties/westlands-apartment.jpg', 1),
...
'A titled 1.5-acre commercial plot inside Konza Technopolis, perfect for mixed-use development. Ready title deed, flat terrain and close to the main highway.', 0, 'images/properties/konza-plot.jpg', 1),
...
'A well-kept townhouse in a guarded community with clubhouse and children play area. Three en-suite bedrooms, servant quarters, and ample parking.', 0, 'images/properties/runda-townhouse.jpg', 1),
...
'Compact and fully finished studio near the Kilimani business district. Includes water heater, fibre internet ready and 24-hour security.', 0, 'images/properties/kilimani-studio.jpg', 1);
